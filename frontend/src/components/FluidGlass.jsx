  ...
  return (
    <Canvas camera={{ position: [0, 0, 20], fov: 15 }} gl={{ alpha: true }}>
      ...
      <Wrapper modeProps={modeProps}>
        {/* Child portals and models handled inside ModeWrapper */}
      </Wrapper>
    </Canvas>
  );
}
...
const ModeWrapper = memo(function ModeWrapper({
  ...
  useFrame((state, delta) => {
    ...
    // Dynamic constant scale based on viewport bounds
    ...
    // Clear background to our NeuroGraph purple theme
    gl.setClearColor(0x050110, 1);
  });
  ...
  return (
    <>
      ...
      <mesh ref={ref} scale={scale ?? 2} rotation-x={Math.PI / 2} {...props}>
        {mode === 'lens' ? <cylinderGeometry args={[1, 1, 0.2, 64]} /> : <boxGeometry args={[2, 2, 2]} />}
        <MeshTransmissionMaterial
