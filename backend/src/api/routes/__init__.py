...
# from src.api.routes.admin import router as admin_router  # Temporarily disabled for debugging
...
# api_router.include_router(admin_router, prefix="/admin", tags=["admin"])  # Temporarily disabled
