...
def get_mcp_tools():
    ...
    from src.mcp.neurograph_mcp import (
        ...
        neurograph_get_memory, GetMemoryInput,
        neurograph_memory_detail, MemoryDetailInput,
    ...
    return {
        ...
        "neurograph_get_memory": (neurograph_get_memory, GetMemoryInput),
        "neurograph_memory_detail": (neurograph_memory_detail, MemoryDetailInput),
...
def get_tool_schemas():
    ...
    return [
        ...
        },
        {
            ...
            "description": "Get detailed memory payload by ID.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "memory_id": {"type": "string"},
